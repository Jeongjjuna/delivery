...
public class OrderLineResponse {
    ...
    public OrderLineResponse(final Long foodId, final Long price,
    ...
    public static OrderLineResponse from(final Long foodId, final Long price,
                                         final Long quantity, final String foodName) {
        return new OrderLineResponse(foodId, price, quantity, foodName);
    }
}
